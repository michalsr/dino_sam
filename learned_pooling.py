...
if __name__ == '__main__':
    ...
    limit_val_batches = 10000 # None for all batches
    lr = 5e-5
    n_epochs = 100
    seed = 42
    ...
    # Number of classes for area-wise labels
    if dataset == Datasets.PASCAL:
        num_classes = 21
    elif dataset == Datasets.ADE20K:
        num_classes = 151
    else:
    ...
    if dataset == Datasets.PASCAL:
        ...
        sam_embed_dir = "/shared/rsaas/dino_sam/sam_region_embeddings/ADE20K/train_upscale"
        dino_feat_dir = "/shared/rsaas/dino_sam/features/dinov2/ADE20K/train"
        train_region_labels_dir = '/shared/rsaas/dino_sam/region_labels/ADE20K/train'
        max_pool_dir = "/shared/rsaas/dino_sam/region_features/dinov2/ADE20K/train"
        sam_folder = "/shared/rsaas/dino_sam/sam_output/ADE20K/train"
    ...
    if dataset == Datasets.PASCAL:
        ...
        sam_embed_val_dir = "/shared/rsaas/dino_sam/sam_region_embeddings/ADE20K/val_upscale"
        dino_feat_val_dir = "/shared/rsaas/dino_sam/features/dinov2/ADE20K/val"
        train_region_labels_val_dir = '/shared/rsaas/dino_sam/region_labels/ADE20K/val'
        max_pool_val_dir = "/shared/rsaas/dino_sam/region_features/dinov2/ADE20K/val"
        sam_val_folder = "/shared/rsaas/dino_sam/sam_output/ADE20K/val"
