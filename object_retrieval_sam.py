...
'''
Object retrieval: for each model, get features for query images, and the evaluation images. 
Take the dot product and compute mAP.  Each query image contains one object. 
'''
# 
...
def compute_single_entry(args,query_features,val_features):
    ...
    max_score = np.mean(dot_product.flatten())
    #print(max_score)
